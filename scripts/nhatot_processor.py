...
class NhatotProcessor:
    def __init__(self, input_dir='/opt/airflow/data/crawled', output_dir='/opt/airflow/data/output'):
    ...
    def process_data(self):
        ...
        try:
            ...
            # Read input file
            input_file_path = os.path.join(self.input_dir, 'nhatot.tsv')
            ...
            # Save processed data
            output_file_path = os.path.join(self.output_dir, f'processed_nhatot.tsv')
