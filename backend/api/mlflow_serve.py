...
def load_models():
    ...
    try:
        ...
        latest_production = client.get_latest_versions("price_prediction_model", stages=["Production"])
        ...
        price_prediction_model = mlflow.xgboost.load_model("models:/price_prediction_model/Production")
